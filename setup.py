...
name = 'trytonar_payment_collect_afip'

download_url = 'https://github.com/tryton-ar/payment_collect_afip/tree/%s.%s' % (
...
setup(name=name,
    ...
    author='tryton-ar',
    url='https://github.com/tryton-ar/payment_collect_afip',
    download_url=download_url,
    package_dir={'trytond.modules.payment_collect_afip': '.'},
    packages=[
        'trytond.modules.payment_collect_afip',
        'trytond.modules.payment_collect_afip.tests',
        ],
    package_data={
        'trytond.modules.payment_collect_afip': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    payment_collect_afip = trytond.modules.payment_collect_afip
    """,
    test_suite='tests',
